...
<label class="cursor-pointer grid place-items-center">
  <input type="checkbox" :checked="modelValue === 'dark' ? true: false" @input="(e : any) => $emit('update:modelValue', e.target.checked ? 'dark' :'light')" class="toggle theme-controller bg-base-content row-start-1 col-start-1 col-span-2"/>
