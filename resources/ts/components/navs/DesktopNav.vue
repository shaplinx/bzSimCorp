<template>
  ...
  <div
    ...
    v-on-click-outside="onClickOutsideMenu"
  ...
  >
          ...
          <template v-for="(item, key) in navigation">
            ...
            >
              <DesktopNavItem
                ...
                :item="item"
                @change:is-active="(val) => onChildActive(val, key)"
                @click="setActiveParent(key)"
              >
              </DesktopNavItem>
              <template #popper>
                <div class="h-screen w-52 bg-base-100 flex flex-col">
                  ...
                  <TreeNav
                    class="overflow-x-hidden overflow-y-auto w-full"
    ...
    <aside
      class="overflow-hidden transition-all transform bg-base-100 z-10 absolute top-0 left-20 h-full"
    >
      <!-- <template v-for="(item, key) in navigation">
